...
?>
                ...
                <?php 
                    ...
                    foreach( $my_posts as $post ){
                        ...
                        ?>
                            ...
                            <li style="background-image: url('<?php the_field('img_slider_header');?>')" class="glide__slide">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-7 offset-1">
                                            ...
                                            ?>"
                                             ...
                                             if($field == 'on') {
                                                ?>
                                                <a href="<?php the_field('link_slider');?>" class="button"><?php the_field('slider_btn_text');?></a>
                                                <?php
                                             }
                                             ?>
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1 col-lg-5 offset-lg-1">
                        <div class="about__img">
                            <?php 
                            $image = get_field('about_company_img');
                            if(!empty($image)): ?>
                    ...
                    <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-6 col-xl-5 offset-xl-1">
                        <h1 class="title underlined"><?php the_field('about_company_h'); ?></h1>
                        <div class="about__text">
                        <?php the_field('about_company_descr'); ?>
                        </div>
        ...
        <div class="specialists" id="specialists">
            <div class="container">
                <div class="title"><?php the_field('our_team_h');?></div>
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?php the_field('img_our_team'); ?>" alt="наша команда">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                <h1 class="title"><?php the_field('our_history_h'); ?></h1>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('our_history_block_1_h');?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('our_history_block_1_descr');?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('our_history_block_1_img'); ?>" alt="мир детства">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('our_history_block_2_img'); ?>" alt="мир детства">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                        <?php the_field('our_history_block_2_h');?>
                        </div>
                        <div class="aboutus__text">
                        <?php the_field('our_history_block_2_descr');?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                        <?php the_field('our_history_block_3_h');?>
                        </div>
                        <div class="aboutus__text">
                        <?php the_field('our_history_block_3_descr');?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('our_history_block_3_img'); ?>" alt="мир детства">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="">
                            ...
                            <?php
                            $field = get_field('choice_maps');
                            if($field == 'Google_maps'){
                                $iframe_code_google = get_field('lat_long_field_google');
                                    if ($iframe_code_google) {
                                        echo $iframe_code_google;
                                    }
                                 }
                                 elseif($field == 'Yandex_maps'){
                                    $iframe_code_yandex = get_field('lat_long_field_yandex');
                                    if ($iframe_code_yandex) {
                                        echo $iframe_code_yandex;
                                    }
                                 }
                            ?>
                            <?php 
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts__info">
                            <div class="contacts__phones">
                                ...
                                <div class="contacts__phoneblock contacts__phoneblock_hidden">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.4887 0.000305176H5.51165C4.74276 0.000305176 4.1167 0.626369 4.1167 1.39525V17.6055C4.1167 18.3747 4.74276 19.0007 5.51165 19.0007H13.4883C14.2575 19.0007 14.8836 18.3747 14.8836 17.6058V1.39525C14.8836 0.626369 14.2575 0.000305176 13.4887 0.000305176ZM4.75005 2.5337H14.2503V14.5673H4.75005V2.5337ZM5.51165 0.633653H13.4883C13.9086 0.633653 14.2503 0.975344 14.2503 1.39525V1.90035H4.75005V1.39525C4.75005 0.975344 5.09174 0.633653 5.51165 0.633653ZM13.4887 18.3674H5.51165C5.09174 18.3674 4.75005 18.0257 4.75005 17.6058V15.2006H14.2503V17.6058C14.2503 18.0257 13.9086 18.3674 13.4887 18.3674Z" fill="url(#paint0_linear)"/>
                                        ...
                                        <a class="phone_hidden" href="tel:<?php the_field('phone_2', 2);?>"><?php the_field('phone_2', 2);?></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="contacts__mail">
                                ...
                                <a href="mailto:<?php the_field('email_field');?>"><?php the_field('email_field');?></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <?php echo do_shortcode('[contact-form-7 id="2cbae50" title="Форма обратной связи 1"]'); ?>
                        </div>
                    </div>
                </div>
                <div class="row mt70">
